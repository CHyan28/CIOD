...
def get_sample_value(txt_name, category_name):
    label_path = '/root/data/iOD/datasets/kitti/training/label_2/'
...
txt_list_path = glob.glob('/root/data/iOD/datasets/kitti/training/label_2/*.txt')
txt_list = []
...
Main_path = '/root/data/iOD/datasets/kitti/ImageSets/Main/'
train_test_name = ['trainval','train','val','test']
# category_name = ['person','car','truck']
category_name = ['truck', 'car', 'misc', 'cyclist', 'pedestrian', 'person_sitting', 'tram', 'van']
