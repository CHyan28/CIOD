...
import iod.data.transforms as T
from iod.checkpoint import DetectionCheckpointer
from iod.data import (
    MetadataCatalog,
    build_detection_test_loader,
    build_detection_train_loader,
)
from iod.evaluation import (
    DatasetEvaluator,
    inference_on_dataset,
    print_csv_format,
    verify_results,
)
from iod.modeling import build_model
from iod.solver import build_lr_scheduler, build_optimizer
from iod.utils import comm
from iod.utils.collect_env import collect_env_info
from iod.utils.env import seed_all_rng
from iod.utils.events import CommonMetricPrinter, JSONWriter, TensorboardXWriter
# from detectron2.utils.logger import setup_logger
from iod.utils.store import Store
from iod.data.datasets.finetune_dataset import ImageStoreDataset
...
class DefaultTrainer(SimpleTrainer):
    ...
    def __init__(self, cfg):
        ...
        # Distillation
        # base_10基类训练不蒸馏
        # 第一阶段：self.enable_distillation = False
        # 第二阶段：15_p_5.yaml:self.enable_distillation = True,model.enable_warp_grad=True, ft_15_p_5.yaml:self.enable_distillation = False
        ...
        if self.enable_distillation:
            ...
            model.set_base_model(self.base_model) # 基类模型不更新
        ...
        if self.cfg.WG.ENABLE:
            ...
            if os.path.exists(file_path):
                ...
                self.image_store = Store(self.cfg.MODEL.ROI_HEADS.NUM_CLASSES, self.cfg.WG.NUM_IMAGES_PER_CLASS) # 构建了20个空的deque，每个deque最大为10
                # print("image_store:",self.image_store)
